...
<div class="page-sidebar">
                ...
                <ul class="x-navigation">
                    <li class="xn-logo">
                        <a href="index.php">EMS Dahsboard</a>
                    ...
                    <li class="xn-profile">
                        ...
                        <div class="profile">
                            ...
                            <div class="profile-data">
                                <div class="profile-data-name"><?php echo @$_SESSION['users']['fullName']; ?></div>
                    ...
                    <li>
                        <a href="profile.php"><span class="fa fa-user"></span> <span class="xn-text">Profile</span></a>
                    ...
                    <?php if($_SESSION['users']['userType']=='Client'){ ?>
                     <li class="nav-item">
