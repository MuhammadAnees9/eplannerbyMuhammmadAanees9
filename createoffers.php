  ...
  <body id="page-top">
    ...
    <div id="wrapper">
      ...
      <div class="card card-login mx-auto mt-5" >
        ...
        <div class="card-body">
          <form method="podt" action="createoffersAction.php">
            ...
            <div class="form-group">
              <h5>% off:</h5>
              <div class="form-label-group">
                <input type="percentage" id="inputPercentage" class="form-control" placeholder="% off" name="percentage" required="required">
