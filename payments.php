          ...
          <div class="container-fluid">
            <div class="page-content">
              <ul class="breadcrumb">
                ...
                $q = mysqli_query($conn, "SELECT `bookings`.*, `business`.* FROM `bookings` LEFT JOIN `business` ON `bookings`.bid=`business`.id WHERE `bookings`.id='$bn'");
                ...
                <div class="row">
                  <div style="margin: 5%" class="col-md-12 col-sm-12 col-xs-12">
                    <ul class="nav nav-tabs">
                      <li class="active">
                        <button type="btn" data-toggle="tab" href="#home">Paypal</button>
                      </li>
                      <li>_</li>
                      <li>
                    ...
                    <div class="tab-content">
                      <div id="home" class="tab-pane fade in active">
                        ...
                        <form action="https://www.paypal.com/cgi-bin/webscr" method="post">
                          <div class="form-group col-sm-6">
                            <input class="form-control" type="text" name="money" readonly="" value="Rs.<?php echo $info['bookingFee'] ?>">
                          </div>
                      ...
                      <div id="menu2" class="tab-pane fade">
                        ...
                        if(isset($_POST['easypaisa'])){
                          ...
                          $amount = $_POST['amount'];
                          $easy = mysqli_query($conn, "INSERT INTO `payments`(cardNumber, amount, method, uid, bid) VALUES('$account', '$amount', 'EasyPaisa', '$uid', '$bn')");
                          if($easy){
                            $up = mysqli_query($conn, "UPDATE `bookings` SET bstatus='Approved' WHERE uid='$uid' AND id='$bn'");
                            if($up)echo "Thanks for Your Payments";
                          }
                        }
                        ?>
