                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                ...
                                <?php 
                                    ...
                                    $uid = $_SESSION['user']['id'];
                                    $q = mysqli_query($conn, "SELECT `business`.*, `services`.sname FROM `business` LEFT JOIN `services` ON `services`.bid=`business`.id GROUP BY `business`.id");
                                    $i=0;
                                ...
                                <span class="col-md-6">
                                    ...
                                    <a class="btn btn-success" href="aproveBusiness.php?id=<?php echo $res['id'] ?>">Approve</a>
                                    <?php } else {
                                        ?>
                                        <a class="btn btn-success disabled" href="aproveBusiness.php?id=<?php echo $res['id'] ?>">Approved</a>
                                   <?php } ?>
                                </span> </div>
                                <h4>Services</h4>
                                <ul>
                                    ...
                                    <?php 
                                    $bid = $res['id'];
                                    $s = mysqli_query($conn, "SELECT * FROM `services` WHERE bid = '$bid'");
