        ...
        <div class="card-body">
          <form method="POST" action="deleteupdateoffers.php">
            <div class="form-group">
              ...
              <div class="form-label-group">
                <input type="Select" id="inputName" class="form-control" placeholder="Select Business" name="selectbusiness" autofocus="autofocus"  value="<?php echo $selectbusiness;?>">
            ...
            <div class="form-group">
              <h5>Offer Name:</h5>
              <div class="form-label-group">
                <input type="Name" id="inputName" class="form-control" placeholder="Offer Name" name="offername" value="<?php echo $offername;?>">
            ...
            <div class="form-group">
              <h5>% off:</h5>
              <div class="form-label-group">
                <input type="percentage" id="inputPercentage" class="form-control" placeholder="% off" name="discount" value="<?php echo $discount;?>">
            ...
            <div class="form-group">
              <h5>Starting From:</h5>
              <div class="form-label-group">
                <input type="Date" id="inputDate" class="form-control" placeholder="calendar" name="startdate" value="<?php echo $startdate;?>">
            ...
            <div class="form-group">
              <h5>End Date:</h5>
              <div class="form-label-group">
                <input type="Date" id="inputDate" class="form-control" placeholder="calendar" name="enddate" value="<?php echo $enddate;?>">
            ...
            <div class="form-group">
              <h5>Description:</h5>
              <div class="form-label-group">
                <input type="text" id="inputDescription" class="form-control" placeholder="Description" name="description" value="<?php echo $description;?>">
